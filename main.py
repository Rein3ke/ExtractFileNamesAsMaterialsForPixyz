...
def __main__(): # Main function
    loadConfig() # Check if materials.config file exists and load the configuration
    loadMaterialIgnoreFile() # Check if materials.ignore file exists
    loadFromCache() # Check if cache file exists and is valid
